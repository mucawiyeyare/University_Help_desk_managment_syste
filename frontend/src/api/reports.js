...
export const getTicketTimeSummaryApi = () => api.get('/reports/time-summary');
export const getResolvedSLAReportApi = () => api.get('/reports/resolved-sla');
...
export const getAgentSLARankingApi = () => api.get('/reports/agent-sla-ranking');
export const getStudentComplaintDepartmentsApi = () => api.get('/reports/student-complaint-departments');
